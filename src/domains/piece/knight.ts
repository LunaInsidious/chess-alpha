...
const getKnightMovablePositions = (boardStatus: BoardStatus, piece: Knight, from: Position): Position[] => {
    const directions = [
...
export class Knight extends Piece {
    getMovablePositions = (boardStatus: BoardStatus, from: Position) => getKnightMovablePositions(boardStatus, this, from);
